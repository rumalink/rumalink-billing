...
SELECT 
  ...
  -- portal, so any voucher this touched became unusable — and running every minute, it undid
  -- corrections within sixty seconds. R429 was told 'dybby5' while RADIUS wanted 'R429'.
